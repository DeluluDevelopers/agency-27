...
import { Code, Database, Brain, Cloud, Smartphone, Globe, Zap, Shield } from "lucide-react"
...
const techCategories = [
  {
    ...
    color: "#61dafb",
    technologies: [
      { name: "React", description: "Modern component-based UI library", icon: "⚛️" },
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "Spring Boot", description: "Java enterprise framework", icon: "🍃" },
  ...
  },
  {
    ...
    color: "#ff6f00",
    technologies: [
      { name: "TensorFlow", description: "Machine learning platform", icon: "🧠" },
      { name: "OpenAI API", description: "GPT integration", icon: "🤖" },
      { name: "Python", description: "AI/ML programming language", icon: "🐍" },
      { name: "Langchain", description: "LLM application framework", icon: "🔗" },
    ],
  },
  {
    name: "Mobile",
    ...
    color: "#a855f7",
    technologies: [
      { name: "React Native", description: "Cross-platform mobile apps", icon: "📱" },
...
export function TechStackSection() {
  ...
  return (
    <section id="tech" className="py-20 bg-gradient-to-r from-blue-950 via-black to-violet-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Cutting-edge technologies that power the future. Explore our comprehensive tech ecosystem.
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {techCategories.map((category, index) => (
            ...
            >
              ...
              {activeCategory === index && (
                <motion.div layoutId="activeIndicator" className="w-2 h-2 bg-blue-400 rounded-full" />
              )}
            </motion.button>
          ))}
        </div>
        ...
        >
          {techCategories[activeCategory].technologies.map((tech, index) => (
            <motion.div
              ...
              className="glass rounded-3xl p-6 hover:neon-blue transition-all duration-300 group cursor-pointer border border-gray-800/50 hover:border-blue-500/30"
            >
              ...
              <motion.div
                ...
                animate={{
                  scale: hoveredTech === index ? [1, 1.02, 1] : 1,
                }}

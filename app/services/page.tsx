...
const services = [
  ...
  },
  {
    ...
    gradient: "from-gray-100/10 to-gray-300/10",
    features: [
      "Data Visualization",
    ...
    <main className='min-h-screen bg-black overflow-hidden'>
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20'>
        ...
        >
          ...
          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6'>
            {technologies.map((tech, index) => (
              ...
              >
                <tech.icon className='w-8 h-8 text-white mx-auto mb-2 group-hover:scale-110 transition-transform duration-300' />
        ...
        <motion.div
          ...
          className='bg-gradient-to-r from-white/10 via-gray-500/10 to-gray-600/10 rounded-3xl p-12 border border-white/20 backdrop-blur-sm'
        >
          <div className='text-center'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
              <Button
                size='lg'
                className='bg-gradient-to-r from-white to-gray-300 hover:from-gray-200 hover:to-gray-400 text-black rounded-xl px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300'
                onClick={() => (window.location.href = "/contact")}
              >
              ...
              <Button
                variant='outline'
                size='lg'
                className='border-2 border-white text-white hover:bg-white hover:text-black rounded-xl px-8 py-4 text-lg font-semibold transition-all duration-300'
                onClick={() =>
                  window.open(
